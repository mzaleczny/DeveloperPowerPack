...
cmake -DWITH_MSI=NO -DWITH_WININSTALL=NO -DWITH_PACKAGE=NO -DWITH_INSTALL=NO -DWITH_DOCS=NO -DWITH_EXAMPLES=NO -DWITH_TESTS=NO -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX="..\..\%OUT_MARIADB_RELEASE%\install" -S . -B "..\..\%OUT_MARIADB_RELEASE%"
cmake --build "..\..\%OUT_MARIADB_RELEASE%" --config Release
cmake --build "..\..\%OUT_MARIADB_RELEASE%" --target install

cmake -DWITH_MSI=NO -DWITH_WININSTALL=NO -DWITH_PACKAGE=NO -DWITH_INSTALL=NO -DWITH_DOCS=NO -DWITH_EXAMPLES=NO -DWITH_TESTS=NO -DCMAKE_BUILD_TYPE=Debug -DCMAKE_INSTALL_PREFIX="..\..\%OUT_MARIADB_DEBUG%\install" -S . -B "..\..\%OUT_MARIADB_DEBUG%"
