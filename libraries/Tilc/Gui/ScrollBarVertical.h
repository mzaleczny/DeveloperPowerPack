...
namespace Tilc {
    namespace Gui {
        ...
        public:
            TScrollBarVertical(TGuiControl* parent, const Tilc::TExtString& name, const SDL_FRect& position, int thumbPosition = 1, int maxValue = 100, int minValue = 1, bool autosize = false);
