...
namespace Tilc {
    namespace Gui {
        ...
        class DECLSPEC TSliderHorizontal : public TScrollBarHorizontal {
        public:
            TSliderHorizontal(TGuiControl* parent, const Tilc::TExtString& name, const SDL_FRect& position, int thumbPosition = 1, int maxValue = 100, int minValue = 1, bool autosize = false); 
            ...
            virtual bool MouseOnBgLeft(int localX, int localY) override;
            virtual bool MouseOnBgRight(int localX, int localY) override;
        };
    }
}
