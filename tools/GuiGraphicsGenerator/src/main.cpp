...
SDL_AppResult SDL_AppIterate(void *appstate)
{
    ...
    CurrentColumnX = X;
    Y = 0;
    RenderButtonsByNamesHorizontal({ "listbox_header", "listbox_header-disabled"}, 75, 20, 2);
    AddY(20, 0);
    X = CurrentColumnWidth;
    RenderButtonsByNamesHorizontal({ "listbox_header-focused", "listbox_header-hover-focused"}, 75, 20, 2);
    AddY(20, 0);
    X = CurrentColumnWidth;
    RenderButtonsByNamesHorizontal({ "listbox_header-hover", "listbox_header-pushed-focused"}, 75, 20, 2);
    AddY(20, 0);
    X = CurrentColumnWidth;
    RenderButtonsByNamesHorizontal({ "listbox_header-pushed"}, 75, 20, 2);
    AddY(20, 0);
    X = CurrentColumnWidth;
