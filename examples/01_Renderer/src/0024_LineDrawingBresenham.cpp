...
void DrawLineBresenham(const SDL_Point& p1, const SDL_Point& p2, int color);

SDL_AppResult SDL_AppInit(void** appstate, int argc, char* argv[])
{
    int i;

    SDL_SetAppMetadata("Bresenham algorithm of line drawing - click within the window to draw a line", "1.0", "com.example.bresenham-line-drawing");
    ...
    if (!SDL_CreateWindowAndRenderer("Bresenham algorithm of line drawing - click within the window to draw a line", WINDOW_WIDTH, WINDOW_HEIGHT, 0, &window, &renderer))
    {
...
SDL_AppResult SDL_AppIterate(void* appstate)
{
    ...
    DrawLineBresenham(StartPoint, EndPoint, 0xffffffff);
