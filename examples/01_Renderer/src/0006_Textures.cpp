...
SDL_AppResult SDL_AppInit(void **appstate, int argc, char *argv[])
{
    ...
    //SDL_asprintf(&bmp_path, "%sassets\\sample.bmp", SDL_GetBasePath());  /* allocate a string of the full file path */
    SDL_asprintf(&bmp_path, ".\\assets\\sample.bmp");  /* allocate a string of the full file path */
