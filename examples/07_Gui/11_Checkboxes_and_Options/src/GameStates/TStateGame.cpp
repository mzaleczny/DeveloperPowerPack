...
TStateGame::TStateGame(Tilc::TStateManager* StateManager) : Tilc::TBaseState(StateManager, true)
{
    ...
    Tilc::Gui::TCheckbox* chk2 = new Tilc::Gui::TCheckbox(wnd, "chk2", { x, y + 30, 100, 100 }, "Checkbox aligned to right in state CHECKED", "Checkbox aligned to right in state UNCHECKED", false, Tilc::Gui::CHECKBOX_TEXT_PLACEMENT_LEFT);
}
