...
Tilc::Graphics::TPointLight PointLight;
...
SDL_AppResult SDL_AppInit(void** appstate, int argc, char* argv[])
{
	...
	PipelineScene = new Tilc::Graphics::OpenGL::TPipeline("assets/shaders/DirectionalPointSpotLightCasters.vs", "assets/shaders/DirectionalPointSpotLightCasters.fs");
	if (!PipelineScene)
	{
...
SDL_AppResult SDL_AppIterate(void* appstate)
{
	...
	if (Mesh->m_DoRender)
	{
		...
		DirectionalLight.SendLightParametersToPipelineOfTheMesh(Mesh, 0);
		// Point light properties
		PointLight.SendLightParametersToPipelineOfTheMesh(Mesh, 0);
		...
		SpotLight.SendLightParametersToPipelineOfTheMesh(Mesh, 0);
		...
		LightModelMatrix = Tilc::Translate(LightModelMatrix, PointLight.m_Position);
