...
{
	std::string WindowTitle("Textured Materials");
	SDL_SetAppMetadata(WindowTitle.c_str(), "1.0", "pl.net.progmar.textured-materials");
	...
	PipelineScene = new Tilc::Graphics::OpenGL::TPipeline("assets/shaders/TexturedMaterials.vs", "assets/shaders/TexturedMaterials.fs");
	if (!PipelineScene)
	{
