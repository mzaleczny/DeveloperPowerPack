...
constexpr const char* GameTitle = "Pixel adventure v.0.1";
constexpr const unsigned int WindowWidth = 1940;
constexpr const unsigned int WindowHeight = 1080;
...
SDL_AppResult SDL_AppInit(void** appstate, int argc, char* argv[])
{
    ...
    SDL_AppResult Result = Tilc::InitTilc(GameTitle, WindowWidth, WindowHeight, true, false);
    ...
    Tilc::GameObject->SwitchToState(Tilc::EStateType::Intro);
